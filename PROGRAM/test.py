...
def main():
    ...
    test_loader = DataLoader(getImageLabel(original=f'C:/Users/REDMI/Documents/PRAK IPSD/TRIAL WEEK10/DATASET/Original Images/FOLDS/', folds=folds, subdir=['Test']), batch_size=BATCH_SIZE, shuffle=True)
